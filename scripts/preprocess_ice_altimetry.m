function [h_annual, dhdt_annual, dhdt_monthly, years, lat_sphere, long_sphere, X, Y] = preprocess_ice_altimetry(data_name, plot_altimetry)
    ...
    % Create years_altimetry for thickness data (has nt+1 elements)
    % years represents years for dhdt_annual, years_altimetry represents years for h_annual
    years_altimetry = [years; years(end) + 1]; % Add one more year for the final thickness
